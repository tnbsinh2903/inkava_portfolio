...
const NikeLogo = () => (
  <svg viewBox="0 0 100 40" className="w-20 h-10 text-white fill-current" xmlns="http://www.w3.org/2000/svg">
    <path d="M15 12c15 8 45 10 75-3-25 12-55 15-70 12-5-1-8-5-5-9z" />
  </svg>
);

const JordanLogo = () => (
  <svg viewBox="0 0 100 100" className="w-11 h-11 text-white fill-current" xmlns="http://www.w3.org/2000/svg">
...
const LacosteLogo = () => (
  <svg viewBox="0 0 100 40" className="w-22 h-10 text-white fill-current" xmlns="http://www.w3.org/2000/svg">
...
const PumaLogo = () => (
  <div className="flex items-center gap-1.5 text-white">
    ...
    <span className="text-sm font-sans font-black tracking-[0.2em] uppercase leading-none">PUMA</span>
  </div>
);

const VictoriasSecretLogo = () => (
  <div className="flex flex-col items-center justify-center text-white text-center">
    <span className="text-xs font-serif tracking-[0.2em] font-bold leading-none">VICTORIA'S</span>
    <span className="text-[10px] font-serif tracking-[0.3em] font-medium leading-none mt-1">SECRET</span>
  </div>
);

const EA7Logo = () => (
  <div className="flex items-center gap-1.5 text-white">
    <span className="text-xl font-serif font-black tracking-tighter leading-none">E<span className="text-xs align-super font-normal italic">X</span>A</span>
    <div className="flex flex-col justify-center border-l border-white/20 pl-1.5 leading-none">
      <span className="text-xs font-sans tracking-[0.1em] text-white/50 leading-none">EMPORIO ARMANI</span>
      <span className="text-xs font-sans font-bold tracking-wider leading-none mt-0.5">EA7</span>
    </div>
  </div>
);
...
const GuessLogo = () => (
  <div className="flex flex-col items-center justify-center text-white text-center">
    <span className="text-sm font-sans font-black tracking-[0.25em] leading-none">GUESS</span>
    <span className="text-[7px] font-mono tracking-[0.35em] text-white/50 uppercase mt-1">LOS ANGELES</span>
  </div>
);
...
const ArenaLogo = () => (
  <div className="flex flex-col items-center justify-center text-white gap-1">
    ...
    <span className="text-xs font-sans font-bold tracking-[0.15em] lowercase leading-none">arena</span>
  </div>
);

const OakleyLogo = () => (
  <div className="flex flex-col items-center justify-center text-white gap-1">
    <svg viewBox="0 0 100 40" className="w-14 h-5 text-white fill-current" xmlns="http://www.w3.org/2000/svg">
      <path d="M50 10c-15 0-25 4-25 10s10 10 25 10 25-4 25-10-10-10-25-10zm0 15c-10 0-15-2-15-5s5-5 15-5 15 2 15 5-5 5-15 5z" />
    </svg>
    <span className="text-[8px] font-sans font-black tracking-[0.3em] uppercase leading-none">OAKLEY</span>
  </div>
);

const ChampionLogo = () => (
  <div className="flex items-center justify-center text-white gap-1 font-serif italic">
    <span className="text-xl font-black tracking-tighter leading-none pr-0.5 border-r border-white/20">C</span>
    <span className="text-xs font-bold tracking-wider leading-none pl-1">Champion</span>
  </div>
);

const WedzeLogo = () => (
  <div className="flex flex-col items-center justify-center text-white text-center">
    <span className="text-sm font-sans font-black tracking-wide italic leading-none">Wed'ze</span>
...
const ColumbiaLogo = () => (
  <div className="flex items-center gap-2 text-white">
    ...
    <span className="text-xs font-sans font-black tracking-widest uppercase">Columbia</span>
  </div>
);

const PetitBateauLogo = () => (
  <div className="flex flex-col items-center justify-center text-white text-center gap-1">
    <svg viewBox="0 0 24 24" className="w-6 h-6 stroke-current text-white fill-none stroke-[2]" xmlns="http://www.w3.org/2000/svg">
      <circle cx="12" cy="12" r="10" />
      <path d="M8 14h8l-4 4zM12 6v8" />
    </svg>
    <span className="text-[7px] font-sans font-black tracking-widest uppercase leading-none">PETIT BATEAU</span>
  </div>
);

const HurleyLogo = () => (
  <div className="flex flex-col items-center justify-center text-white">
    <svg viewBox="0 0 100 40" className="w-16 h-8 text-white fill-current" xmlns="http://www.w3.org/2000/svg">
...
const QuechuaLogo = () => (
  <div className="flex items-center gap-1.5 text-white">
    <svg viewBox="0 0 24 24" className="w-5 h-5 stroke-current text-white fill-none stroke-[2.5]" xmlns="http://www.w3.org/2000/svg">
      <path d="M4 14l5-5 5 5 6-6" />
    </svg>
    <span className="text-xs font-sans font-black tracking-widest uppercase italic">Quechua</span>
  </div>
);

const OlaianLogo = () => (
  <div className="flex items-center gap-1.5 text-white">
    <span className="text-xs font-sans font-black tracking-[0.2em] uppercase">OLAIAN</span>
...
const NabaijiLogo = () => (
  <div className="flex items-center gap-1 text-white text-center">
    <span className="text-xs font-sans font-bold tracking-wide lowercase">nabaiji</span>
...
const ConverseLogo = () => (
  <div className="flex flex-col items-center justify-center text-white gap-1">
    ...
    <span className="text-[8px] font-sans font-black tracking-[0.25em] uppercase leading-none">CONVERSE</span>
  </div>
);
...
const KalenjiLogo = () => (
  <div className="flex items-center gap-1.5 text-white">
    ...
    <span className="text-xs font-sans font-bold tracking-wide italic leading-none">Kalenji</span>
  </div>
);

const DomyosLogo = () => (
  <div className="flex flex-col items-center justify-center text-white">
    <span className="text-xs font-sans font-black tracking-[0.2em] uppercase leading-none">DOMYOS</span>
  </div>
);

const HbiLogo = () => (
  <div className="flex items-center justify-center text-white">
    <span className="text-lg font-serif tracking-tight font-black leading-none italic">Hbi</span>
  </div>
);

const WellLogo = () => (
  <div className="flex items-center justify-center text-white">
    <span className="text-base font-serif italic tracking-wide font-medium leading-none">Well</span>
  </div>
);
...
const CamaieuLogo = () => (
  <div className="flex items-center justify-center text-white">
    <span className="text-[11px] font-sans font-black tracking-[0.25em] uppercase leading-none">CAMAÏEU</span>
  </div>
);

const AdoreMeLogo = () => (
  <div className="flex flex-col items-center justify-center text-white text-center">
    <span className="text-xs font-serif tracking-widest font-black italic leading-none">ADORE ME</span>
...
const CarrefourLogo = () => (
  <div className="flex flex-col items-center justify-center text-white gap-1">
    <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current text-white" xmlns="http://www.w3.org/2000/svg">
      <path d="M19 12c-1.5 0-2.5-1-2.5-2.5S17.5 7 19 7s2.5 1 2.5 2.5S20.5 12 19 12zM5 12c1.5 0 2.5-1 2.5-2.5S6.5 7 5 7 2.5 8 2.5 9.5 3.5 12 5 12z" className="opacity-30" />
      <path d="M12 3l-6 6h12zM12 21l6-6H6z" />
    </svg>
    <span className="text-[7.5px] font-sans font-black tracking-widest uppercase leading-none">Carrefour</span>
  </div>
);

const WalmartLogo = () => (
  <div className="flex items-center gap-1.5 text-white">
    <span className="text-xs font-sans font-black tracking-tight leading-none uppercase">Walmart</span>
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current text-amber-400" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2v6M12 16v6M5 5l4.5 4.5M14.5 14.5L19 19M5 19l4.5-4.5M14.5 9.5L19 5" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
    </svg>
  </div>
);
...
const AmazonLogo = () => (
  <div className="flex flex-col items-center justify-center text-white">
    <span className="text-xs font-sans font-black tracking-wide lowercase leading-none">amazon</span>
    <svg viewBox="0 0 24 24" className="w-8 h-2 fill-current text-amber-500" xmlns="http://www.w3.org/2000/svg">
...
export const Brands: React.FC<BrandsProps> = ({ brands = [] }) => {
  ...
  return (
    <section id="brands" className="py-24 bg-[#11422E] text-white scroll-mt-20">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center mb-16">
          ...
          <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white uppercase tracking-tight max-w-3xl mx-auto leading-tight">
            Thương hiệu tin cậy & Đối tác chiến lược
          </h3>
          <p className="text-xs sm:text-sm text-gray-300 font-light mt-2 max-w-xl mx-auto">
            Hân hạnh đồng hành sản xuất bao bì cao cấp phục vụ hàng triệu người tiêu dùng toàn cầu.
          </p>
        </div>

        {/* 5-Column Grid on Desktop, matching the user photo exactly */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-y-12 gap-x-8 md:gap-y-16 md:gap-x-12 items-center justify-items-center">
            ...
            >
              <div className="flex items-center justify-center transform hover:brightness-110 transition-all duration-300">
                {brand.logo.startsWith("preset:") ? (
                  BRAND_PRESET_MAP[brand.logo] || <span className="text-xs text-white/50">{brand.name}</span>
                ) : (
                  <img 
                    src={brand.logo} 
                    alt={brand.name} 
